...
aws cloudformation create-stack --stack-name cdc332soaktest-VPC --template-url https://s3-us-west-2.amazonaws.com/sdfe-testresources/test/SDFE-SeGrid-20150219-VPC-usw2-cdc332.template  --parameters ParameterKey=MaxASGSize,ParameterValue=3 --capabilities CAPABILITY_IAM --region us-west-2
sleep 5m
...
aws cloudformation create-stack --stack-name cdc332soaktest --template-url https://s3-us-west-2.amazonaws.com/sdfe-testresources/sdfeFrontEnd/SDFE-SeGrid-20150219-se1-cdc332.template  --parameters ParameterKey=MaxASGSize,ParameterValue=3 --capabilities CAPABILITY_IAM --region ap-southeast-1
...
aws cloudformation create-stack --stack-name cdc332soaktest --template-url https://s3-us-west-2.amazonaws.com/sdfe-testresources/sdfeFrontEnd/SDFE-SeGrid-20150219-EU-cdc332.template  --parameters ParameterKey=MaxASGSize,ParameterValue=3 --capabilities CAPABILITY_IAM --region eu-west-1
