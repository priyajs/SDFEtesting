...
try:
  #csvRd = csv.reader(open('/home/ubuntu/PIIs_250k.csv','rb'))
  SDcsvRd = csv.reader(open('/home/ubuntu/sdPII.csv','rb'))
  piiCount = 4300
except:
  SDcsvRd = csv.reader(open('C:/Scripts/sdPII.csv','rb'))
  piiCount = 4300
for k in SDcsvRd:
  SDPII.append(k)
...
while numLoops > loop:
  ...
  try:
    ...
    #while(browserLoop < 5):
      ...
      #print str(idx)+' '+envPrint+' '+Pii+' '+url
